...
const PROMPT_TYPES: Record<string, { title: string; platform: string; instructions: string }> = {
  "master":        { title: "Prompt Mestre Lovable",     platform: "Lovable",   instructions: "Crie um prompt mestre completo para o Lovable que descreve todo o sistema, incluindo stack tecnológica, funcionalidades principais, design system e fluxos de usuário. Seja extremamente detalhado e inclua exemplos de componentes." },
  "frontend":      { title: "Frontend Completo",          platform: "Lovable",   instructions: "Gere um prompt de frontend React detalhado incluindo: componentes de UI, rotas, estados, hooks customizados, responsividade e acessibilidade. Use shadcn/ui e Tailwind." },
...
Gere um prompt completo, detalhado e pronto para usar diretamente em ${typeConfig.platform}. 
O prompt deve ser em português, ter pelo menos 400 palavras e ser extremamente específico para este projeto.
Comece o prompt diretamente — sem introduções ou explicações sobre o que você vai fazer.`;
